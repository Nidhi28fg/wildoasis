                        ...
                        >
                            ...
                            <div className="p-6 md:p-10">
                                <div className="flex items-center justify-between mb-4">
                                    <h3 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">{cabin.name}</h3>
                                ...
                                <div className="flex items-center justify-between mt-auto">
                                    ...
                                    <Link
                                        href={`/book/${cabin.id}`}
                                        className="px-4 py-3 md:p-4 bg-gray-900 dark:bg-white dark:text-gray-900 text-white rounded-xl md:rounded-2xl hover:bg-indigo-600 dark:hover:bg-indigo-400 dark:hover:text-white transition-all shadow-lg group-hover:px-6 text-sm font-bold"
                                    >
                                        Details
                                    </Link>
                                </div>
